...
// we need to convert the UIKit SignInWithApple button to SwiftUI
struct SignInWithAppleButtonViewRepresentable: UIViewRepresentable { // UIViewRepresentable is how we convert a UIView into SwiftUI
